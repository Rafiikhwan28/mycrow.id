  ...
  return (
    ...
    >
      ...
      {(reasons?.items?.length > 0 || benefits) && (
        <section className="relative pt-16 sm:pt-28 md:pt-32">
          <div className="px-3 sm:px-5 mx-auto max-w-7xl">
            <motion.div
              ...
              whileInView="visible"
              viewport={{ once: true }}
              className="relative bg-white rounded-tl-[28px] rounded-tr-[28px] sm:rounded-tl-[40px] sm:rounded-tr-[40px] shadow-[0_40px_120px_rgba(0,0,0,0.18)] border border-white/40 px-4 sm:px-6 md:px-16 py-10 sm:py-20 md:py-24"
            >
              {/* ================= REASONS ================= */}
              {reasons?.items?.length > 0 && (
                <div className="mb-14 sm:mb-28 md:mb-36">
                  <motion.h2
                    variants={fadeUp}
                  ...
                  <motion.div
                    variants={staggerContainer}
                    className="grid gap-4 sm:gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-4"
                  >
                    {reasons.items.map((item, i) => (
                      <motion.div
                        ...
                        variants={fadeUpSoft}
                        whileHover={{ y: -6 }}
                        className="p-5 sm:p-8 text-center transition shadow-lg rounded-3xl hover:shadow-2xl"
                      >
                        <img
                          src={item.icon}
                          alt={item.title}
                          className="mx-auto mb-4 sm:mb-6 h-12 sm:h-14"
                        />
                        <h3 className="mb-2 sm:mb-3 text-sm sm:text-base font-semibold">{item.title}</h3>
              ...
              {benefits && (
                <div className="max-w-5xl mx-auto">
                  <motion.h2
                    variants={fadeUp}
                    className="mb-3 sm:mb-4 text-xl sm:text-2xl font-semibold text-center text-purple-700"
                  >
                    {benefits.title}
                  </motion.h2>
                  ...
                  <motion.p
                    variants={fadeUp}
                    className="max-w-3xl mx-auto mb-10 sm:mb-20 text-sm sm:text-base text-center text-gray-700 md:text-lg"
                  >
